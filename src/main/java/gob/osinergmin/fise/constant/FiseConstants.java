...
public class FiseConstants {
	...
	public static final String NOMBRE_IMPRESION_ESQUELA_INVITACION = "IMPRESION_ESQUELA_INVITACION";
	public static final String NOMBRE_IMPRESION_DECLARACION_JURADA = "IMPRESION_DECLARACION_JURADA";
	public static final String NOMBRE_IMPRESION_FICHAS_VERIFICACION = "IMPRESION_FICHAS_VERIFICACION";
	public static final String NOMBRE_REPARTO_ESQUELA_INVITACION = "REPARTO_ESQUELA_INVITACION";
	public static final String NOMBRE_VERIFICACION_INFORMACION = "VERIFICACION_INFORMACION";
	public static final String NOMBRE_ELABORACION_ARCHIVO_BENEF = "ELABORACION_ARCHIVO_BENEF";
	public static final String NOMBRE_DIGITACION_FICHA_BENEF = "DIGITACION_FICHA_BENEF";
	public static final String NOMBRE_TOTAL_EMPADRONAMIENTO = "TOTAL_EMPADRONAMIENTO";
	public static final String NOMBRE_IMPRESION_VOLANTES = "IMPRESION_VOLANTES";
	public static final String NOMBRE_IMPRESION_AFICHES = "IMPRESION_AFICHES";
	public static final String NOMBRE_REPARTO_FOLLETO_POTENCIA_BENEF = "REPARTO_FOLLETO_POTENCIA_BENEF";
	public static final String NOMBRE_SPOT_PUBLICITARIO_TV = "SPOT_PUBLICITARIO_TV";
	public static final String NOMBRE_SPOT_PUBLICITARIO_RADIO = "SPOT_PUBLICITARIO_RADIO";
	public static final String NOMBRE_TOTAL_DIFUSION_INICIO_PRG_FISE = "TOTAL_DIFUSION_INICIO_PRG_FISE";
	public static final String NOMBRE_NUMERO_BENEF_EMPADRO_MES_DIC = "NUMERO_BENEF_EMPADRO_MES_DIC";
	public static final String NOMBRE_COSTO_UNITARIO_EMPADRONAMIENTO = "COSTO_UNITARIO_EMPADRONAMIENTO";
	public static final String NOMBRE_PROMOCION_CONVENIO_AG_AUT_GLP = "PROMOCION_CONVENIO_AG_AUT_GLP";
	public static final String NOMBRE_REGISTRO_FIRMA_CONV_AG_AUT_GLP = "REGISTRO_FIRMA_CONV_AG_AUT_GLP";
	public static final String NOMBRE_IMPRESION_ENTREGA_BANDEROLA = "IMPRESION_ENTREGA_BANDEROLA";
	public static final String NOMBRE_TOTAL_COSTO_GESTION_RED_AG_GLP = "TOTAL_COSTO_GESTION_RED_AG_GLP";
	public static final String NOMBRE_NUMERO_AGENTES = "NUMERO_AGENTES";
	public static final String NOMBRE_COSTO_UNTITARIO_AGENTE_GLP = "COSTO_UNTITARIO_AGENTE_GLP";
