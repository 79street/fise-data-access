...
/**
 * The primary key class for the FISE_FORMATO_12C_C database table.
 * 
 */
@Embeddable
public class FiseFormato12CCPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato12CCPK)) {
			return false;
		}
		FiseFormato12CCPK castOther = (FiseFormato12CCPK)other;
		return 
