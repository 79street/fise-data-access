...
/**
 * The primary key class for the FISE_FORMATO_12D_D_OBS database table.
 * 
 */
@Embeddable
public class FiseFormato12DDObPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato12DDObPK)) {
			return false;
		}
		FiseFormato12DDObPK castOther = (FiseFormato12DDObPK)other;
		return 
