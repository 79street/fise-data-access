...
/**
 * The primary key class for the FISE_FORMATO_14A_D_OBS database table.
 * 
 */
@Embeddable
public class FiseFormato14ADObPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato14ADObPK)) {
			return false;
		}
		FiseFormato14ADObPK castOther = (FiseFormato14ADObPK)other;
		return 
