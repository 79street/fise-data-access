...
/**
 * The primary key class for the FISE_FORMATO_14B_C database table.
 * 
 */
@Embeddable
public class FiseFormato14BCPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato14BCPK)) {
			return false;
		}
		FiseFormato14BCPK castOther = (FiseFormato14BCPK)other;
		return 
