...
/**
 * The primary key class for the FISE_FORMATO_14B_D_OBS database table.
 * 
 */
@Embeddable
public class FiseFormato14BDObPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato14BDObPK)) {
			return false;
		}
		FiseFormato14BDObPK castOther = (FiseFormato14BDObPK)other;
		return 
