...
/**
 * The primary key class for the FISE_FORMATO_14B_D database table.
 * 
 */
@Embeddable
public class FiseFormato14BDPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato14BDPK)) {
			return false;
		}
		FiseFormato14BDPK castOther = (FiseFormato14BDPK)other;
		return 
