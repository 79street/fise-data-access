...
/**
 * The primary key class for the FISE_FORMATO_12B_D_OBS database table.
 * 
 */
@Embeddable
public class FiseFormato12BDObPK implements Serializable {
	...
	private Integer itemObservacion;

	public FiseFormato12BDObPK() {
	}
	...
	public Integer getItemObservacion() {
		return this.itemObservacion;
	}
	public void setItemObservacion(Integer itemObservacion) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato12BDObPK)) {
			return false;
		}
		FiseFormato12BDObPK castOther = (FiseFormato12BDObPK)other;
		return 
