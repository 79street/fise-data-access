...
/**
 * The primary key class for the FISE_FORMATO_12D_C database table.
 * 
 */
@Embeddable
public class FiseFormato12DCPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato12DCPK)) {
			return false;
		}
		FiseFormato12DCPK castOther = (FiseFormato12DCPK)other;
		return 
