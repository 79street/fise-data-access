...
/**
 * The primary key class for the FISE_FORMATO_12D_D database table.
 * 
 */
@Embeddable
public class FiseFormato12DDPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato12DDPK)) {
			return false;
		}
		FiseFormato12DDPK castOther = (FiseFormato12DDPK)other;
		return 
