...
/**
 * The primary key class for the FISE_FORMATO_13A_D database table.
 * 
 */
@Embeddable
public class FiseFormato13ADPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato13ADPK)) {
			return false;
		}
		FiseFormato13ADPK castOther = (FiseFormato13ADPK)other;
		return 
