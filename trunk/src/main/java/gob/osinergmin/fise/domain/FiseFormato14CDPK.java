...
/**
 * The primary key class for the FISE_FORMATO_14C_D database table.
 * 
 */
@Embeddable
public class FiseFormato14CDPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FiseFormato14CDPK)) {
			return false;
		}
		FiseFormato14CDPK castOther = (FiseFormato14CDPK)other;
		return 
