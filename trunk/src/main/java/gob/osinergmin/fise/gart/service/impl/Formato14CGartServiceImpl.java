...
public class Formato14CGartServiceImpl implements Formato14CGartService {
		  ...
		  /***Grabando en la cabecera*/			
			...
			if(cab==null){				
				...
				if(validarDato(bean.getNumRural())){
					cab.setNumBenefEmpPerAntRural(Long.valueOf(valorCantidad(bean.getNumRural())));	
				}			
				if(validarDato(bean.getNumUrbProv())){
					cab.setNumBenefEmpPerAntUrbProv(Long.valueOf(valorCantidad(bean.getNumUrbProv())));	
				}	
						...
						FiseConstants.COD_EMPRESA_LUZ_SUR.equals(bean.getCodEmpresa()))
				{
					if(validarDato(bean.getNumUrbLima())){
						cab.setNumBenefEmpPerAntUrbLima(Long.valueOf(valorCantidad(bean.getNumUrbLima())));	
					}				
	...
	private int valorCantidad(String valor){
		if(valor != null && valor.indexOf(".") > 0){
			return Integer.valueOf(valor.substring(0, valor.indexOf(".")));
		}else{
